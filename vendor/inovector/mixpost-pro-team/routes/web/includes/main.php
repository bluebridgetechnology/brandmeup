...
Route::prefix('profile')->name('profile.')->group(function () {
    ...
    Route::get('/change_password', [ProfileController::class, 'create'])->name('password.change');
    Route::post('/change_password', [ProfileController::class, 'store'])->name('password.change.store');
