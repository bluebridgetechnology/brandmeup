...
use Inovector\Mixpost\Http\Base\Controllers\Workspace\MembersController;
...
Route::middleware(array_merge([
    ...
    ->group(function () {
        ...
        Route::prefix('posts')->name('posts.')->group(function () {
            ...
            Route::post('decline/{post}', [SchedulePostController::class,'decline'])->name('declinePost');
        ...
        Route::prefix('members')->name('members.')->group(function () {
            ...
            Route::get('edit/{template}', [MembersController::class, 'edit'])->name('edit');
