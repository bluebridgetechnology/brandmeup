...
class SocialProviderManager extends SocialProviderManagerAbstract
{
    ...
    public function providers(): array
    {
        ...
        return $this->providers = [
            ...
            'facebook_group' => FacebookGroupProvider::class,
    ...
    protected function connectTwitterProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'twitter']);
    ...
    protected function connectFacebookPageProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'facebook_page']);
    ...
    protected function connectFacebookGroupProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'facebook_group']);
    ...
    protected function connectInstagramProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'instagram']);
    ...
    protected function connectYoutubeProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'youtube']);
    ...
    protected function connectPinterestProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'pinterest']);
        $config['values'] = [
    ...
    protected function connectLinkedinProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'linkedin']);
    ...
    protected function connectLinkedinPageProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'linkedin_page']);
    ...
    protected function connectTiktokProvider()
    {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'tiktok']);
    ...
    protected function connectMastodonProvider()
    {
        ...
        $sessionServerKey = "{$this->config->get('br.cache_prefix')}.mastodon_server";

        if ($request->route() && $request->route()->getName() === 'br.accounts.add') {
        ...
        } else if ($request->route() && $request->route()->getName() === 'br.callbackSocialProvider') {
        ...
        $config['redirect'] = route('br.callbackSocialProvider', ['provider' => 'mastodon']);
        $config['values'] = [
