...
use Inovector\Mixpost\Http\Base\Requests\Workspace\StorePost;
use Inovector\Mixpost\Http\Base\Requests\Workspace\UpdatePost;
...
class PostsController extends Controller
{
    ...
    public function store(StorePost $storePost): RedirectResponse
    {
        ...
        return redirect()->route('br.posts.edit', ['workspace' => $post->workspace->uuid, 'post' => $post->uuid]);
    }
