...
<template>
    <div class="w-full h-full flex flex-col pb-2xl pt-20 bg-white border-r border-gray-200">
        ...
        <div class="relative mb-12 px-xl">
            <Link :href="route('br.dashboardAdmin')">
                <Logo/>
            </Link>
        </div>
        ...
        <div class="flex flex-col space-y-lg overflow-y-auto px-xl h-full">
            <MenuGroupBody>
                <MenuItem :url="route('br.dashboardAdmin')"
                ...
                <template v-if="!enterpriseConsole.url">
                    <MenuItem :url="route('br.users.index')" :active="$page.component === 'Admin/Users/Users'">
                        <template #icon>
                            <UsersIcon/>
                        </template>
                        {{ $t('user.users') }}
                    </MenuItem>
                    <MenuItem :url="route('br.workspaces.index')"
            ...
            <MenuGroupBody>
                <MenuItem :url="route('br.services.index')"
                ...
                <MenuItem :url="route('br.configs.theme.form')"
                ...
                <MenuItem :url="route('br.pages.index')" :active="$page.component === 'Admin/Pages/Pages'">
                    <template #icon>
                        <BookOpen/>
                    </template>
                    {{ $t('page.pages') }}
            ...
            <MenuGroupBody>
                <template v-if="enterpriseConsole.is_system_webhook_enabled">
                    <MenuItem :url="route('br.system.webhooks.index')"
                ...
                <MenuItem :url="route('br.system.status')" :active="$page.component === 'Admin/System/Status'">
                    <template #icon>
                        <InformationCircle/>
                    </template>
                    {{ $t('system.status') }}
                </MenuItem>
                <MenuItem :url="route('br.system.logs.index')" :active="$page.component === 'Admin/System/Logs'">
                    <template #icon>
                        <Document/>
                    </template>
                    {{ $t('system.logs') }}
