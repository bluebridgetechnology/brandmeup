...
const renameTag = () => {
    ...
    router.put(route('br.tags.update', {workspace: workspaceCtx.id, tag: props.item.uuid}), {
        action: 'name',
...
const deleteTag = () => {
    router.delete(route('br.tags.delete', {workspace: workspaceCtx.id, tag: props.item.uuid}), {
        onStart() {
