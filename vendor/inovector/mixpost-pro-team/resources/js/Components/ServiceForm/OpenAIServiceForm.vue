...
const save = () => {
    ...
    router.put(route('br.services.update', {service: 'openai'}), props.form, {
        preserveScroll: true,
        onSuccess() {
...
<template>
    <Panel class="mt-lg">
        ...
        <template #description>
            ...
            <ReadDocHelp :href="`${$page.props.mixpost.docs_link}/books/integration-of-social-platforms/page/open-ai`"
                         class="mt-xs"/>
        </template>
