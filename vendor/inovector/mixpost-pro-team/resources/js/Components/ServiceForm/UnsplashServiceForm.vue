...
const save = () => {
    ...
    router.put(route('br.services.update', {service: 'unsplash'}), props.form, {
        preserveScroll: true,
        onSuccess() {
...
<template>
    <Panel>
        ...
        <template #description>
            ...
            <ReadDocHelp :href="`${$page.props.mixpost.docs_link}/books/integration-of-social-platforms/page/unsplash`"
                         class="mt-xs"/>
        </template>
