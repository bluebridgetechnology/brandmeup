...
const storeUser = () => {
    formStoreUser.post(route('br.workspaces.users.store', {workspace: props.workspace.uuid}), {
            preserveScroll: true,
            onSuccess() {
...
const updateUserRole = () => {
    formEditUser.put(route('br.workspaces.users.update', {workspace: props.workspace.uuid}), {
            preserveScroll: true,
            onSuccess() {
