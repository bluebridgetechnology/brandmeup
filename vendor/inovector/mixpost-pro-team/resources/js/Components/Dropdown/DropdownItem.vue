...
const classes = computed(() => {
    return `flex items-center w-full first:rounded-t-md last:rounded-b-md text-gray-800 transition ease-in-out duration-200 ${props.isActive ? 'bg-primary-100' : 'hover:bg-gray-100'}`;
});
