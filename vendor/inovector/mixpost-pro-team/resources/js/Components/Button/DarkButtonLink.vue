...
<template>
    <Link :href="href" :class="sizeClass"
          class="inline-flex items-center bg-black border border-transparent rounded-md font-medium text-xs text-primary-context uppercase tracking-widest hover:bg-black active:black focus:border-primary-900 focus:shadow-outline-indigo transition ease-in-out duration-200">
