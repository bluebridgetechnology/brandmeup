...
const useMedia = (routeName = 'br.media.fetchUploads', routeParams = {}) => {
    ...
    const downloadExternal = (items, callback) => {
        ...
        axios.post(route('br.media.download', routeParams), {
            items,
    ...
    const deletePermanently = (items, callback) => {
        ...
        axios.delete(route('br.media.delete', routeParams), {
            data: {
                items
            }
        }).then(() => {
